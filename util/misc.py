...
def load_model(args, model_without_ddp, optimizer, loss_scaler):
    if args.resume:
        check_list = os.listdir(args.output_dir)
        check_list = [int(i.replace("checkpoint-", '').replace(".pth", '')) for i in check_list if i.startswith("checkpoint")]
        max_epoch = max(check_list)
        resume = str(args.output_dir + 'checkpoint-'+str(max_epoch)+'.pth')
